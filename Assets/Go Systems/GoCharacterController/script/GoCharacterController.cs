    ...
    public class GoCharacterController : GoSystemsBehaviour
    {
        ...
        private void JumpAvoidance()
        {
            if (Gs.IsLockJump) return;
                ...
                {
                    GoSystemsController.rigidbody.linearVelocity = new Vector3(GoSystemsController.rigidbody.linearVelocity.x, -8, GoSystemsController.rigidbody.linearVelocity.z);
