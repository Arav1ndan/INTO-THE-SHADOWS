...
namespace GoSystem
{
    namespace Control
    {
        public class GoSystemsController
        {
            ...
            public static PhysicsMaterial PhysicMaterialfly
            {
                get
                {
                    return (PhysicsMaterial)Resources.Load("JumpMateral");
                }
            }
            public static PhysicsMaterial PhysicMaterialMove
            {
                get
                {
                    return (PhysicsMaterial)Resources.Load("MoveMateral");
                }
            }
            bool INTRESTING;
            ...
            public static void GoUseGravety(bool value)
            {
                ...
                Charcter.GetComponent<Rigidbody>().linearVelocity = Vector3.zero;
            }
