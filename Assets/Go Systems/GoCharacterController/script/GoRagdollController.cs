...
namespace GoSystem
{
    ...
    public class GoRagdollController : GoSystemsBehaviour
    {
        ...
        private CharacterController _characterController;
         float _timeToWakeUp; public float TimeToWakeUp = 4f;
      ...
      [HideInInspector]  public bool ActivateRagDoll; private float savetime; public float fallTime = 2f;
        ...
        {
            var Movemint = _hipsBone.GetComponent<Rigidbody>().linearVelocity.magnitude;
        ...
        public void EnableRagDallSystem(bool Lock)
        {
            RagDall = Lock;
